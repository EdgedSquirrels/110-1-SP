...
jmp_buf MAIN;
jmp_buf SCHEDULER;
TCB_ptr Head;    // TCB of the Head thread
TCB_ptr Current; // TCB of the current thread
TCB_ptr Work;    // TCB of the working thread
...
int main(int argc, char *argv[]){
    ...
    switchmode = atoi(argv[5]); // 0: switch when each yield occurs, 1: switch by signal and alarm
